...
import com.crashaviatorjogo.slod.view.viewmodels.Aviator11SettingsViewModel

@Composable
fun Aviator11SettingsScreen(navHostController: NavHostController) {
    val viewModel = hiltViewModel<Aviator11SettingsViewModel>()
    ...
    ConstraintLayout(aviator11SettingsConstraint(), Modifier.fillMaxSize()) {
        ...
        Image(painter = painterResource(id = R.drawable.ok), contentDescription = "",
            Modifier.layoutId("av11sApply")
                .clickable {
                    viewModel.aviator11SaveSettings()
                    navHostController.popBackStack()
                })
        Image(painter = painterResource(id = R.drawable.text_settings), contentDescription = "",
        ...
        Row(Modifier.layoutId("av11sContent"),
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally,
                ...
                Image(painter = painterResource(id = R.drawable.select), contentDescription = "",
                    Modifier.clickable { viewModel.aviator11SelectBackground()  })
            }
            Column(horizontalAlignment = Alignment.CenterHorizontally,
                verticalArrangement = Arrangement.spacedBy(10.dp)
            ) {
                ...
                Image(painter = painterResource(id = R.drawable.select), contentDescription = "",
                    Modifier.clickable { viewModel.aviator11SelectPlane()  })
            }
        }
    }
}